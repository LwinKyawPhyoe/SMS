          ...
          <div class="textbox" id="photo">
            ...
            <label for="stuPhoto">Student Photo</label>
              ...
              <div class="inputbox" v-else>
                ...
                <img :src="student.student_image" alt="error" style="height: 25px;width: auto;" v-if="student.student_image">
        ...
        <div class="row">
          ...
          <div class="textbox">
            ...
            <input type="file" class="inputbox" @change="onFileChange($event,'father')"   id="faPhoto"  accept="image/*" v-if="!student.father_photo">
              <div class="inputbox" v-else>
                <div style="width:100%;padding:0;">
                <img :src="student.father_image" alt="error1" style="height: 25px;width: auto;" v-if="sibling_id">
                <img :src="student.father_image"  style="height: 25px;width: auto;" alt="error3" v-if="student.father_image">
                <img :src="'father_image/'+student.father_photo" alt="error2" style="height: 25px;width: auto;" v-else>
        ...
        <div class="row">
          ...
          <div class="textbox">
            ...
            <input type="file" class="inputbox" @change="onFileChange($event,'mother')"   id="moPhoto"  accept="image/*" v-if="!student.mother_photo">
              <div class="inputbox" v-else>
                <div style="width:100%;padding:0;">
               <img :src="student.mother_image" alt="error1" style="height: 25px;width: auto;" v-if="sibling_id">
                <img :src="student.mother_image"  style="height: 25px;width: auto;" alt="error3" v-if="student.mother_image">
                <img :src="'mother_image/'+student.mother_photo" alt="error2" style="height: 25px;width: auto;" v-else>
          ...
          <div class="textbox">
            ...
            <input type="file" class="inputbox" @change="onFileChange($event,'guardian')"   id="guPhoto"  accept="image/*" v-if="!student.guardian_photo">
              <div class="inputbox" v-else id="showguPhoto">
                <div style="width:100%;padding:0;">
                <img :src="student.guardian_image" alt="error1" style="height: 25px;width: auto;" v-if="student.guardian_image">
  ...
  created() {
    ...
    this.axios
      ...
      .then(response=>{
        ...
        if(this.student.hostel_room_id){
          this.axios
          .get(`api/student/studentHostel/${this.student.hostel_room_id}`)
          .then(response=>{
            this.student.hostel_id = response.data[0].id;
          })
        }
   ...
   onFileChange(e,type) {
      ...
      this.axios
          ...
          .then(response=> {
            ...
            if(response.data =="This Email Already Exists"){
              ...
              alert(this.message);
            }else if(response.data == "This Phone Already Exists"){
              this.message = response.data;
              alert(this.message);
            }else if(response.data == "Successfully updated"){
              this.$router.push({name: 'StudentInformation'}); 
              this.message = response.data;
              this.addSessions();
              // this.refreshForm();
              alert(this.message);
    ...
    addSessions(){
      this.session = {
       ...
       this.axios
      .post(`api/sessions/update/${this.student.admission_no}`,this.session)
      .then(response=>{
      })
      .catch(errors=>{
      })
