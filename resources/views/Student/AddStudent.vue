              ...
              <div class="card-body" style="padding: 1rem;">
                <div class="modalinput">
                  ...
                  >
                    ...
                    <option v-for="data in classList" :key="data.id" :value="data.id">{{data.class}}</option>
                  </select>
                </div>
                <div class="modalinput">
                  <label for="section">
          ...
          <div class="row">
            ...
            <div class="textbox">
              ...
              <VueCtkDateTimePicker
                ...
                :formatted="'l'"
              >
                <input id="admDate" class="inputbox" autocomplete="off" />
              </VueCtkDateTimePicker>
            ...
            <div class="textbox">
              ...
              <VueCtkDateTimePicker
                ...
                :formatted="'l'"
              >
                <input id="regDate" class="inputbox" autocomplete="off" />
              </VueCtkDateTimePicker>
            ...
            <div class="textbox">
              ...
              <div class="inputbox" v-else id="showguPhoto">
                <div style="width:100%;padding:0;">
                  ...
                  />
                  <img
                    :src="guardian_src+'/'+student.guardian_photo"
                    alt="error"
                    style="height: 25px;width: auto;"
                    v-else
                  />
              ...
              <div class="row">
                <div class="textarea">
                  ...
                  <select id="routelist" class="inputbox" v-model="student.route_id">
                    ...
                    <option
                      v-for="list in routeList"
                      :key="list.id"
                      :value="list.id"
                    >{{list.route_title}}</option>
                  </select>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    addStudent() {
      ...
      formData.append(
        "sibling_admission_no",
        this.student.sibling_admission_no
      );
      this.axios
