            ...
            <form @submit.prevent="addDesignation">
              ...
              <div class="col-12">
                ...
                <button
                  ...
                  id="globalSave"
                >Save</button>
                <button v-else @click="updateDesignation()" id="globalSave" type="button" class="save">Save</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div class="card-body">
            ...
            <div class="copyRows">
              <div class="row" id="copyRow">
                <div class="col-3">
                  <a href="#" @click.prevent="downloadExcel('studenttable', 'name', 'Designation.xls')" title="Excel">
