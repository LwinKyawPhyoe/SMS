...
export default {
    ...
    methods: 
    {
        getTeacherPie()
        {
            this.teacher = [{name: 'Teacher Male', y: 17, color : "#259FED"},{name: 'Teacher Female', y: 23, color : "#01BC0B"}];
        },
        ...
        getStudentPie()
        {
            this.student = [{name: 'Student Male', y: 379, color : "#259FED"},{name: 'Student Female', y: 421, color : "#01BC0B"}];
        },
        ...
        getAdminPie()
        {
            this.admin = [{name: 'Admin Male', y: 2, color : "#259FED"},{name: 'Admin Female', y: 3, color : "#01BC0B"}];
        },
        ...
        getStaffPie()
        {
           this.staff = [{name: 'Staff Male', y: 10, color : "#259FED"},{name: 'Staff Female', y: 40, color : "#01BC0B"}];
        },
        ...
        {
            this.attendance = [
                {name: 'Teacher', data: [99,98,85,90, 78,80,88,90, 75,90,60,70], color: "#259FED"},
                {name: 'Student', data: [90,88,89,95, 75,70,80,97, 85,78,87,100], color: "#01BC0B"},
                {name: 'Admin', data: [100,90,99,100, 80,60,75,100, 88,80,90,88], color: "#FF0101"},
                {name: 'Staff', data: [89,100,98,98, 100,98,92,95, 100,98,94,100], color: "#2501FF"}
            ]
        },

        showAttendanceLine()
        {
            var myChart = Dashboard.generateLineChart('attendancePie', this.attendance);
        },
