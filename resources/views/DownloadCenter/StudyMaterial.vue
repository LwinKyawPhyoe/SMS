<template>
  <div class="form" id="bar">
    <div class="toplink">
      ...
      <h4 class="stuLink">
        <router-link to="/home" class="home">Home</router-link>> Study Material
      </h4>
    </div>
    <hr />
...
export default 
{
  ...
  methods: {
    // Get Content
      getContent(){
      this.ContentList = [];
      this.axios.post('/api/content/show',{'type':'Study Material'}).then(response => {
