            ...
            <form @submit.prevent="goSave">
              <div class="col-12">
                ...
                <input
                  ...
                  id="vehicle_number"
                  class="inputbox"
                  v-model="tranVehicle.vehicle_no"
              ...
              <div class="col-12">
                ...
                <input
                  type="text"
                  class="inputbox"
                  v-model="tranVehicle.driver_contact"
            ...
            <div class="copyRows">
              <div class="row" id="copyRow">
                <div class="col-3">
                  <a
                    href="#"
                    @click.prevent="downloadExcel('studenttable', 'name', 'Tran_Vehicles.xls')"
                    title="Excel"
                  >
  ...
  methods: {
    ...
    goSave() {
      if (this.checkValidate()) {
        this.axios
          .post("/api/TranVehicle/save", this.tranVehicle)
          .then(response => {
            this.tranVehicle = {
              id: "",
              vehicle_no: "",
    ...
    checkValidate() {
      if (
        this.tranVehicle.vehicle_no == "" ||
        this.tranVehicle.vehicle_no == undefined
      ) {
