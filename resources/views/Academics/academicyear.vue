                ...
                <tbody id="myTable">
                  <tr v-for="session in SessionList" :key="session.id" class="active">
                    ...
                    <td v-if="session.is_active != 'delete'" style="text-align:right;">
                      ...
                      <i
                        :class="{ 'checkActive': session.is_active === 'yes'}"
                        @click="goDelete(session.id, session.is_active)"
                        data-toggle="modal"
...
export default {
  ...
  methods: {
    ...
    checkValidate() {
      ...
      if (
        this.AcademicYr.session == "" ||
        this.AcademicYr.session == undefined
      ) {
