      ...
      <div class="card-body">
        <div class="row" id="row" style="margin: 0px;">
          <div class="col-lg-6 col-md-6 col-12 textbox">
            ...
            <select
              id="classid"
              @change="changeClass(PromoteStudObj.class_id)"
              class="inputbox"
              name="class"
              v-model="PromoteStudObj.class_id"
            >
              <option
          ...
          <div class="col-lg-6 col-md-6 col-12 textbox">
            ...
            <select
              id="sectionid"
              @change="changeSection(PromoteStudObj.section_id)"
              class="inputbox"
              name="class"
              v-model="PromoteStudObj.section_id"
            >
              <option
